/* Celem zadania jest napisanie standardowego konetnera, jakim jest tablica
liczb całkowitych. Tablica ta musi mieć rozmiar określany dynamicznie podczas
działania programu. Rozwiązanie z tablicami statycznimi jest oceniane na 0
punktów! Korzystanie z kontenrów biblioteki standardowej jest zabronione!
...
int main() {
	std::cout << "Zadanie zaliczeniowe: Moja tablica liczb calkowitych!"
			  << std::endl;
